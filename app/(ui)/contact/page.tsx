...
export default function Contact() {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/Kamil-Zuki",
      icon: (
    ...
    {
      name: "Telegram",
      url: "https://t.me/LukaGtta",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.568 8.16l-1.61 7.592c-.121.54-.44.675-.89.42l-2.46-1.814-1.185 1.14c-.131.131-.241.241-.495.241l.177-2.51 4.573-4.13c.199-.177-.044-.276-.307-.099l-5.65 3.56-2.435-.763c-.53-.165-.541-.53.11-.784l9.57-3.69c.44-.165.826.099.682.784z" />
        </svg>
      ),
    },
    {
      name: "Email (Yandex)",
      url: "mailto:karatovkamil@yandex.ru",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
